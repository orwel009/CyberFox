        ...
        <div className={`wrapper${action}`}>
            <div className="form-box login">
                <form action="" onSubmit={logReadValue}>
                    ...
                    <div className="register-link">
                        <p>Don't have an account? <Link className='link-tag' to='/login' onClick={registerLink}>Register</Link></p>
                    </div>
                </form>
            </div>
            ...
            <div className="form-box register">
                <form action="" onSubmit={regReadValue}>
                    ...
                    <div className="register-link">
                        <p>Already have an account? <Link className='link-tag' to='/login' onClick={loginLink}>Login</Link></p>
                    </div>
                </form>
            </div>
        </div>
